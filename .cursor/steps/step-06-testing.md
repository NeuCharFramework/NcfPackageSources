...
- [ ] examine`ADMIN_AdminChatSession`Whether the table is created successfully
- [ ] examine`ADMIN_AdminChatMessage`Whether the table is created successfully
- [ ] examine`ADMIN_AdminChatSessionModule`Whether the table is created successfully
...
| operate | target time | actual time | state |
|------|---------|---------|------|
| Home page loading | < 2s | _To be tested_ | ⏳ |
| Conversation page loads | < 2s | _To be tested_ | ⏳ |
| Send message (with AI reply) | < 3s | _To be tested_ | ⏳ |
| Switch session | < 1s | _To be tested_ | ⏳ |
| Load 50 messages | < 1s | _To be tested_ | ⏳ |
