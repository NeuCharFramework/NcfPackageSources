...
**reason**:
- ApiHelper was originally designed to use jQuery`$.ajax`method
...
**Usage in existing code** (prompt.js is already in use):
...
**document**:`Areas/Admin/Pages/PromptRange/Prompt.cshtml`
...
**document**:`utils/README.md`

Added description about existing API packages for the project:
...
Although not used yet, it is retained`apiHelper.js`document:
...
| StorageHelper | storageHelper.js | ✅ Use | LocalStorage encapsulation |
| CopyHelper | copyHelper.js | ✅ Use | Clipboard operations |

### ⏸️ Tools not used yet

| Tools | document | state | reason |
|--------|------|------|------|
