...
#region 角色管理
            ...
            IEnumerable<SysPermission> sysPermissions = new List<SysPermission>()
            {
                ...
                new SysPermission() { PermissionId = "1.1", ResourceCode = string.Empty, RoleId = "1", RoleCode = "administrator", IsMenu = true },
                new SysPermission() { PermissionId = "1.1.1", ResourceCode = string.Empty, RoleId = "1", RoleCode = "administrator", IsMenu = true },
                new SysPermission() { PermissionId = "1.1.2", ResourceCode = string.Empty, RoleId = "1", RoleCode = "administrator", IsMenu = true },
                new SysPermission() { PermissionId = "1.1.3", ResourceCode = string.Empty, RoleId = "1", RoleCode = "administrator", IsMenu = true },
                new SysPermission() { PermissionId = "1.1.4", ResourceCode = string.Empty, RoleId = "1", RoleCode = "administrator", IsMenu = true },
                new SysPermission() { PermissionId = "1.1.5", ResourceCode = string.Empty, RoleId = "1", RoleCode = "administrator", IsMenu = true } ,
                new SysPermission() { PermissionId = "1.1.6", ResourceCode = string.Empty, RoleId = "1", RoleCode = "administrator", IsMenu = true } ,
                new SysPermission() { PermissionId = "1.2", ResourceCode = string.Empty, RoleId = "1", RoleCode = "administrator", IsMenu = true },
                new SysPermission() { PermissionId = "1.2.1", ResourceCode = string.Empty, RoleId = "1", RoleCode = "administrator", IsMenu = true },
                new SysPermission() { PermissionId = "1.2.2", ResourceCode = string.Empty, RoleId = "1", RoleCode = "administrator", IsMenu = true },
                new SysPermission() { PermissionId = "1.2.3", ResourceCode = string.Empty, RoleId = "1", RoleCode = "administrator", IsMenu = true },
                new SysPermission() { PermissionId = "1.2.4", ResourceCode = string.Empty, RoleId = "1", RoleCode = "administrator", IsMenu = true },
                new SysPermission() { PermissionId = "1.2.5", ResourceCode = string.Empty, RoleId = "1", RoleCode = "administrator", IsMenu = true },
            ...
            //INSERT [dbo].[SysMenus] ([Id], [Flag], [AddTime], [LastUpdateTime], [MenuName], [ParentId], [Url], [Icon], [Sort], [Visible], [AdminRemark], [Remark]) VALUES (N'67855ef5-ab6b-4e93-978f-b618e5306000', 0, CAST(N'2019-08-14T17:30:01.4833756' AS DateTime2), CAST(N'2019-11-04T15:10:24.4180192' AS DateTime2), N'模块管理', N'538e9d87-e9da-4541-9269-13c3bc99bb90', N'/Admin/XncfModule', N'fa fa-user-secret', 10, 1, NULL, NULL)
