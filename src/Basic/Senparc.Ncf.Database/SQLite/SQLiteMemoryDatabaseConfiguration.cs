...
namespace Senparc.Ncf.Database.SQLite
{
    ...
    /// </summary>
    public class SQLiteMemoryDatabaseConfiguration : DatabaseConfigurationBase<SqliteDbContextOptionsBuilder, SqliteOptionsExtension>, IDatabaseConfiguration<SqliteDbContextOptionsBuilder, SqliteOptionsExtension>
    {
        ...
        public override void UseDatabase(DbContextOptionsBuilder optionsBuilder, string connectionString, Action<SqliteDbContextOptionsBuilder> dbContextOptionsAction = null)
        {
