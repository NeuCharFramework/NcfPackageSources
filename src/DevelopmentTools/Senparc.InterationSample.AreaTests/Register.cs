...
namespace Senparc.InterationSample.AreaTests
{
        ...
        IAreaRegister //注册 XNCF 页面接口（按需选用）
    {
        ...
        public override string Name => "InterationSample.AreaTests";
        ...
        public IMvcBuilder AuthorizeConfig(IMvcBuilder builder, IHostEnvironment env)
        {
            ...
            SenparcTrace.SendCustomLog("InterationSample.AreaTests 启动", "完成 Area:InterationSample.AreaTests 注册");
