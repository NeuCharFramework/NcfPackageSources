...
namespace Senparc.Xncf.Application
{
    ...
    public class Register : XncfRegisterBase, IXncfRegister
    {
        ...
        public override string MenuName => NcfBuiltInResource.Get("Module.Application.MenuName", "应用程序模块");
        public override string Icon => "fa fa-pencil";
        public override string Description => NcfBuiltInResource.Get("Module.Application.Description", "此模块允许开发者启动外部程序！");
