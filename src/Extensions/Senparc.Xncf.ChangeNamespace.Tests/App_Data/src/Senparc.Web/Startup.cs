...
namespace Senparc.Web
{
    public class Startup
    {
            ...
            IOptions<SenparcWeixinSetting> senparcWeixinSetting, IHubContext<ReloadPageHub> hubContext)
        {
            ...
            var registerService = app
                ...
                .UseSenparcWeixin(senparcWeixinSetting.Value, weixinRegister =>
                {
                    ...
                    #region 注册微信支付（按需）
                        ...
                        //注册最新微信支付版本（V3）（可注册多个）
                        .RegisterTenpayV3(senparcWeixinSetting.Value, "NCF") //记录到同一个 SenparcWeixinSettingItem 对象中
            ...
            //Senparc.Ncf.Core.Config.SiteConfig.SenparcCoreSetting = senparcCoreSetting.Value;//网站设置

            //提供网站根目录
            if (env.ContentRootPath != null)
            {
                Senparc.Ncf.Core.Config.SiteConfig.ApplicationPath = env.ContentRootPath;
                Senparc.Ncf.Core.Config.SiteConfig.WebRootPath = env.WebRootPath;
            }
