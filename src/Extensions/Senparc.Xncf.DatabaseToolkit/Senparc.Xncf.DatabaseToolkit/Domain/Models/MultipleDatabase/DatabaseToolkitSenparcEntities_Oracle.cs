...
{
    /// <summary>
    /// Class used to generate Oracle database migration information, please do not modify it
    /// </summary>
    ...
    /// <para>2. Run: PM> add-migration [update name] -C DatabaseToolkitSenparcEntities_Oracle -o Domain/Migrations/Migrations.Oracle </para>
    /// </summary>
