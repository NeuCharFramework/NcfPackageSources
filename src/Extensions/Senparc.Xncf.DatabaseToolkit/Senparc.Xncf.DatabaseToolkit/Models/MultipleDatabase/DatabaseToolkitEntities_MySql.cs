...
namespace Senparc.Xncf.DatabaseToolkit.Models.MultipleDatabase
{
    ...
    public class DatabaseToolkitEntities_MySql : DatabaseToolkitEntities, IMultipleMigrationDbContext
    {
        public DatabaseToolkitEntities_MySql(DbContextOptions<DatabaseToolkitEntities_MySql> dbContextOptions) : base(dbContextOptions)
        {
        }
    }
    ...
    /// </summary>
    public class SenparcDbContextFactory_MySql : SenparcDesignTimeDbContextFactoryBase<DatabaseToolkitEntities_MySql, Register>
    {
