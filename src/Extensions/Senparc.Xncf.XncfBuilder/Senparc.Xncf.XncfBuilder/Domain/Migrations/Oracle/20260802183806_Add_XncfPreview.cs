/*----------------------------------------------------------------
    ...
    文件名：20260802183806_Add_XncfPreview.cs
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProcessId = table.Column<int>(type: "NUMBER(10)", nullable: false),
                    ...
                    ProcessStartedAtUtc = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: true),
                    HealthyAtUtc = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: true),
                    StoppedAtUtc = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: true),
                    ExitCode = table.Column<int>(type: "NUMBER(10)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProgressPercent = table.Column<int>(type: "NUMBER(10)", nullable: false),
                    StatusMessage = table.Column<string>(type: "NVARCHAR2(1000)", maxLength: 1000, nullable: true),
                    ...
                    RecentOutput = table.Column<string>(type: "NCLOB", nullable: true),
                    StartedAtUtc = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: false),
                    UpdatedAtUtc = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: false),
