/*----------------------------------------------------------------
    ...
    文件名：20260802160218_Add_XncfPreview.cs
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ModuleProjectName = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false),
                    Url = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
                    ProcessId = table.Column<int>(type: "INTEGER", nullable: false),
                    EnvironmentName = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    PublishDirectory = table.Column<string>(type: "TEXT", maxLength: 1200, nullable: true),
                    Status = table.Column<int>(type: "INTEGER", nullable: false),
                    StatusMessage = table.Column<string>(type: "TEXT", maxLength: 1000, nullable: true),
                    ProcessStartedAtUtc = table.Column<DateTime>(type: "TEXT", nullable: true),
                    HealthyAtUtc = table.Column<DateTime>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SessionId = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false),
                    ModuleProjectName = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false),
                    SolutionFilePath = table.Column<string>(type: "TEXT", maxLength: 1200, nullable: true),
                    Stage = table.Column<int>(type: "INTEGER", nullable: false),
                    ProgressPercent = table.Column<int>(type: "INTEGER", nullable: false),
                    StatusMessage = table.Column<string>(type: "TEXT", maxLength: 1000, nullable: true),
                    ErrorMessage = table.Column<string>(type: "TEXT", nullable: true),
                    SourceFingerprint = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
                    ModuleAssemblySha256 = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
