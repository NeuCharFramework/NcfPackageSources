...
namespace Senparc.Xncf.ChangeNamespace
{
    ...
    public class Register : XncfRegisterBase, IXncfRegister
    {
        ...
        public override string MenuName => NcfBuiltInResource.Get("Module.ChangeNamespace.MenuName", "修改命名空间");
        public override string Icon => "fa fa-space-shuttle";//参考如：https://colorlib.com/polygon/gentelella/icons.html
        public override string Description => NcfBuiltInResource.Get("Module.ChangeNamespace.Description", "此模块提供给开发者在安装完 NCF、发布产品之前，全局修改命名空间，请在生产环境中谨慎使用，此操作不可逆！必须做好提前备份！不建议在已经部署至生产环境并开始运行后使用此功能！");
