        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BotTokenProtected = table.Column<string>(type: "nvarchar(max)", maxLength: 4096, nullable: true),
                    IlinkBotId = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    IlinkUserId = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    GetUpdatesBuf = table.Column<string>(type: "nvarchar(max)", maxLength: 100000, nullable: true),
