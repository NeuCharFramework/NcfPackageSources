        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "NUMBER(10)", nullable: false)
                        .Annotation("Oracle:Identity", "START WITH 1 INCREMENT BY 1"),
                    MpAccountId = table.Column<int>(type: "NUMBER(10)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "NUMBER(10)", nullable: false)
                        .Annotation("Oracle:Identity", "START WITH 1 INCREMENT BY 1"),
                    MpAccountId = table.Column<int>(type: "NUMBER(10)", nullable: false),
                    Subscribe = table.Column<int>(type: "NUMBER(10)", nullable: false),
                    OpenId = table.Column<string>(type: "NVARCHAR2(2000)", nullable: false),
                    ...
                    Subscribe_Time = table.Column<long>(type: "NUMBER(19)", nullable: false),
                    UnionId = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    Remark = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    Groupid = table.Column<int>(type: "NUMBER(10)", nullable: false),
                    Subscribe_Scene = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    Qr_Scene = table.Column<long>(type: "NUMBER(10)", nullable: false),
                    Qr_Scene_Str = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    Flag = table.Column<bool>(type: "NUMBER(1)", nullable: false),
                    AddTime = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: false),
                    LastUpdateTime = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: false),
                    TenantId = table.Column<int>(type: "NUMBER(10)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    UserTagId = table.Column<int>(type: "NUMBER(10)", nullable: false),
                    WeixinUserId = table.Column<int>(type: "NUMBER(10)", nullable: false),
                    Flag = table.Column<bool>(type: "NUMBER(1)", nullable: false),
                    AddTime = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: false),
                    LastUpdateTime = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: false),
                    TenantId = table.Column<int>(type: "NUMBER(10)", nullable: false),
