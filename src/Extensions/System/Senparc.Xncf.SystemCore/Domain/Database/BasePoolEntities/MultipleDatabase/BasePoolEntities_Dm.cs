...
namespace Senparc.Xncf.SystemCore.Domain.Database
{
    ...
    public class BasePoolEntities_Dm : BasePoolEntities
    {
        public BasePoolEntities_Dm(DbContextOptions<BasePoolEntities_Dm> dbContextOptions, IServiceProvider serviceProvider) : base(dbContextOptions, serviceProvider)
        {
        }
    }
    ...
    /// <para>4. Run: PM> add-migration [update name] -Context BasePoolEntities_Dm -o SystemEntities/Migrations/Migrations.Dm.SystemEntities</para>
    /// </summary> 
    public class SenparcDbContextFactory_Dm : SenparcDesignTimeDbContextFactoryBase<BasePoolEntities_Dm, Register>
    {
