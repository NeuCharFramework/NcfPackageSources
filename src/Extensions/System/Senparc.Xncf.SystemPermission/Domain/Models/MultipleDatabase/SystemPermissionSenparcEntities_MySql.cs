...
namespace Senparc.Xncf.SystemPermission.Models
{
    ...
    public class SystemPermissionSenparcEntities_MySql : SystemPermissionSenparcEntities
    {
        public SystemPermissionSenparcEntities_MySql(DbContextOptions<SystemPermissionSenparcEntities_MySql> dbContextOptions) : base(dbContextOptions)
        {
        }
    }
    ...
    /// <para>2. Run: PM> add-migration [update name] -c MenuSenparcEntities_MySql -o Domain/Migrations/Migrations.MySql </para>
    /// </summary>
    public class SenparcDbContextFactory_MySql : SenparcDesignTimeDbContextFactoryBase<SystemPermissionSenparcEntities_MySql, Register>
    {
