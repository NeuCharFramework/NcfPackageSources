...
namespace Senparc.Xncf.SystemPermission.Models
{
    ...
    public class SystemPermissionSenparcEntities_SqlServer : SystemPermissionSenparcEntities
    {
        public SystemPermissionSenparcEntities_SqlServer(DbContextOptions<SystemPermissionSenparcEntities_SqlServer> dbContextOptions) : base(dbContextOptions)
        {
        }
    }
    ...
    /// <para>2. Run: PM> add-migration [update name] -c MenuSenparcEntities_SqlServer -o Domain/Migrations/Migrations.SqlServer </para>
    /// </summary>
    public class SenparcDbContextFactory_SqlServer : SenparcDesignTimeDbContextFactoryBase<SystemPermissionSenparcEntities_SqlServer, Register>
    {
