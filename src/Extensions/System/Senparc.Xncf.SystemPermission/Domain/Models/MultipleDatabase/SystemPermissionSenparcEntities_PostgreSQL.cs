...
namespace Senparc.Xncf.SystemPermission.Models
{
    ...
    public class SystemPermissionSenparcEntities_PostgreSQL : SystemPermissionSenparcEntities
    {
        public SystemPermissionSenparcEntities_PostgreSQL(DbContextOptions<SystemPermissionSenparcEntities_PostgreSQL> dbContextOptions) : base(dbContextOptions)
        {
        }
    }
    ...
    /// <para>2. Run: PM> add-migration [update name] -c MenuSenparcEntities_PostgreSQL -o Migrations/Migrations.PostgreSQL </para>
    /// </summary>
    public class SenparcDbContextFactory_PostgreSQL : SenparcDesignTimeDbContextFactoryBase<SystemPermissionSenparcEntities_PostgreSQL, Register>
    {
