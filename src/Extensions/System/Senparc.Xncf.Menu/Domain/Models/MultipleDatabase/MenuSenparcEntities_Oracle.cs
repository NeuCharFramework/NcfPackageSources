...
namespace Senparc.Xncf.Menu.Models
{
    ...
    public class MenuSenparcEntities_Oracle : MenuSenparcEntities
    {
        public MenuSenparcEntities_Oracle(DbContextOptions<MenuSenparcEntities_Oracle> dbContextOptions) : base(dbContextOptions)
        {
        }
    }
    ...
    /// <para>2、运行：PM> add-migration [更新名称] -c MenuSenparcEntities_Oracle -o Domain/Migrations/Migrations.Oracle </para>
    /// </summary>
