...
namespace Senparc.Xncf.SystemManager.Domain.DatabaseModel
{
    ...
    {
        public SystemManagerSenparcEntities_Sqlite(DbContextOptions<SystemManagerSenparcEntities_Sqlite> dbContextOptions) : base(dbContextOptions)
        {
        }
    }
    ...
    /// <para>2. Run: PM> add-migration [update name] -c SystemManagerSenparcEntities_Sqlite -o Domain/Migrations/Migrations.Sqlite </para>
    /// </summary>
    public class SenparcDbContextFactory_Sqlite : SenparcDesignTimeDbContextFactoryBase<SystemManagerSenparcEntities_Sqlite, Register>
    {
