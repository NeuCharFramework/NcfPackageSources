...
public class Register : XncfRegisterBase, IXncfRegister
{
    ...
    public override string MenuName => NcfBuiltInResource.Get("Module.Dapr.MenuName", "Dapr 模块");
    public override string Icon => "fa fa-car";
    public override string Description => NcfBuiltInResource.Get("Module.Dapr.Description", "此模块为其他模块提供 Dapr 相关功能");
