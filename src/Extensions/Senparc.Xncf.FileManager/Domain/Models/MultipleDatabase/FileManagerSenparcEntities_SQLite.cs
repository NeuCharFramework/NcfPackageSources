...
namespace Senparc.Xncf.FileManager.Models
{
    ...
    public class FileManagerSenparcEntities_Sqlite : FileManagerSenparcEntities
    {
        public FileManagerSenparcEntities_Sqlite(DbContextOptions<FileManagerSenparcEntities_Sqlite> dbContextOptions) : base(dbContextOptions)
        {
        }
    }
    ...
    /// <para>2. Run: PM> add-migration [update name] -c FileManagerSenparcEntities_Sqlite -o Domain/Migrations/Migrations.Sqlite </para>
    /// </summary>
    public class SenparcDbContextFactory_Sqlite : SenparcDesignTimeDbContextFactoryBase<FileManagerSenparcEntities_Sqlite, Register>
    {
