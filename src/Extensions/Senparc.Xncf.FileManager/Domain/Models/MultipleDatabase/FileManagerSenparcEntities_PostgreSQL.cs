...
namespace Senparc.Xncf.FileManager.Models
{
    ...
    public class FileManagerSenparcEntities_PostgreSQL : FileManagerSenparcEntities
    {
        public FileManagerSenparcEntities_PostgreSQL(DbContextOptions<FileManagerSenparcEntities_PostgreSQL> dbContextOptions) : base(dbContextOptions)
        {
        }
    }
    ...
    /// <para>2. Run: PM> add-migration [update name] -c FileManagerSenparcEntities_PostgreSQL -o Migrations/Migrations.PostgreSQL </para>
    /// </summary>
    public class SenparcDbContextFactory_PostgreSQL : SenparcDesignTimeDbContextFactoryBase<FileManagerSenparcEntities_PostgreSQL, Register>
    {
