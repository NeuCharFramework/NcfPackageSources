...
namespace Senparc.Xncf.FileManager.Models
{
    ...
    public class FileManagerSenparcEntities_SqlServer : FileManagerSenparcEntities
    {
        public FileManagerSenparcEntities_SqlServer(DbContextOptions<FileManagerSenparcEntities_SqlServer> dbContextOptions) : base(dbContextOptions)
        {
        }
    }
    ...
    /// <para>2. Run: PM> add-migration [update name] -c FileManagerSenparcEntities_SqlServer -o Domain/Migrations/Migrations.SqlServer </para>
    /// </summary>
    public class SenparcDbContextFactory_SqlServer : SenparcDesignTimeDbContextFactoryBase<FileManagerSenparcEntities_SqlServer, Register>
    {
