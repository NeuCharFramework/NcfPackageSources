...
namespace Senparc.Xncf.KnowledgeBase.Models
{
    ...
    public class KnowledgeBaseSenparcEntities_MySql : KnowledgeBaseSenparcEntities
    {
        public KnowledgeBaseSenparcEntities_MySql(DbContextOptions<KnowledgeBaseSenparcEntities_MySql> dbContextOptions) : base(dbContextOptions)
        {
        }
    }
    ...
    /// <para>2. Run: PM> add-migration [update name] -c KnowledgeBaseSenparcEntities_MySql -o Domain/Migrations/Migrations.MySql </para>
    /// </summary>
    public class SenparcDbContextFactory_MySql : SenparcDesignTimeDbContextFactoryBase<KnowledgeBaseSenparcEntities_MySql, Register>
    {
