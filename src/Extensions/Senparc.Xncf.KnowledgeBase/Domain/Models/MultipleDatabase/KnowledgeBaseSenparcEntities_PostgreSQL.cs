...
namespace Senparc.Xncf.KnowledgeBase.Models
{
    ...
    public class KnowledgeBaseSenparcEntities_PostgreSQL : KnowledgeBaseSenparcEntities
    {
        public KnowledgeBaseSenparcEntities_PostgreSQL(DbContextOptions<KnowledgeBaseSenparcEntities_PostgreSQL> dbContextOptions) : base(dbContextOptions)
        {
        }
    }
    ...
    /// <para>2. Run: PM> add-migration [update name] -c KnowledgeBaseSenparcEntities_PostgreSQL -o Migrations/Migrations.PostgreSQL </para>
    /// </summary>
    public class SenparcDbContextFactory_PostgreSQL : SenparcDesignTimeDbContextFactoryBase<KnowledgeBaseSenparcEntities_PostgreSQL, Register>
    {
