...
namespace Senparc.Xncf.KnowledgeBase.Models
{
    ...
    public class KnowledgeBaseSenparcEntities_Sqlite : KnowledgeBaseSenparcEntities
    {
        public KnowledgeBaseSenparcEntities_Sqlite(DbContextOptions<KnowledgeBaseSenparcEntities_Sqlite> dbContextOptions) : base(dbContextOptions)
        {
        }
    }
    ...
    /// <para>2. Run: PM> add-migration [update name] -c KnowledgeBaseSenparcEntities_Sqlite -o Domain/Migrations/Migrations.Sqlite </para>
    /// </summary>
    public class SenparcDbContextFactory_Sqlite : SenparcDesignTimeDbContextFactoryBase<KnowledgeBaseSenparcEntities_Sqlite, Register>
    {
