/*----------------------------------------------------------------
    ...
    文件名：20260822164609_Add_AgentExecutionTasks.cs
    文件功能描述：20260822164609_Add_AgentExecutionTasks.cs 相关实现
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Output = table.Column<string>(type: "NVARCHAR2(32767)", nullable: true),
                    ErrorMessage = table.Column<string>(type: "NVARCHAR2(32767)", nullable: true),
                    EventsJson = table.Column<string>(type: "NVARCHAR2(32767)", nullable: true),
