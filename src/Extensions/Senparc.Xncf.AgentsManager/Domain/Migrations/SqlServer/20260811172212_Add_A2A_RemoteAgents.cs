/*----------------------------------------------------------------
    ...
    文件名：20260811172212_Add_A2A_RemoteAgents.cs
    文件功能描述：数据库迁移与模型快照
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AgentCardUrl = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    ...
                    AuthSecretKey = table.Column<string>(type: "nvarchar(max)", nullable: true),
