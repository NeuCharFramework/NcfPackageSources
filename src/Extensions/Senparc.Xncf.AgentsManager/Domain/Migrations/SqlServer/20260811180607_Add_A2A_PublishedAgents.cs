        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PublicAgentKey = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    Enable = table.Column<bool>(type: "bit", nullable: false),
                    CardName = table.Column<string>(type: "nvarchar(120)", maxLength: 120, nullable: true),
                    CardDescription = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    SkillId = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    SkillName = table.Column<string>(type: "nvarchar(120)", maxLength: 120, nullable: true),
                    SkillDescription = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    AllowFunctionCalls = table.Column<bool>(type: "bit", nullable: false),
                    ...
                    AuthSecretKey = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
