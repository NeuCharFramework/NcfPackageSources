/*----------------------------------------------------------------
    ...
    文件名：20260811172225_Add_A2A_RemoteAgents.cs
    文件功能描述：数据库迁移与模型快照
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AuthHeaderName = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    AuthSecretKey = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    ...
                    LastHealthCheckMessage = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RemoteAgentId = table.Column<int>(type: "NUMBER(10)", nullable: false),
                    Enable = table.Column<bool>(type: "NUMBER(1)", nullable: false),
                    ContextSharingMode = table.Column<int>(type: "NUMBER(10)", nullable: true),
                    Flag = table.Column<bool>(type: "NUMBER(1)", nullable: false),
                    AddTime = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: false),
                    LastUpdateTime = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: false),
                    TenantId = table.Column<int>(type: "NUMBER(10)", nullable: false),
