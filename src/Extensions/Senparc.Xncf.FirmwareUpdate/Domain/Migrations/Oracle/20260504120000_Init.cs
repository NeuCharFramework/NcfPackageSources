    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                AutoMirrorEnabled = table.Column<bool>(type: "NUMBER(1)", nullable: false),
                UpdateIntervalHours = table.Column<int>(type: "NUMBER(10)", nullable: false),
                LastPeriodicSyncUtc = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: true),
