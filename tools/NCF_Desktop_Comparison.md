[中文版](NCF_Desktop_Comparison.cn.md)
...
| Features | Console version | GUI version | Remarks |
|---------|-----------|---------|------|
| **🚀 Basic functions** |
| Automatically download NCF | ✅ | ✅ | All support GitHub API |
...
| Health check mechanism | ✅ | ✅ | Waiting for the site to be ready |
| **🎨 User Interface** |
| Command line interface | ✅ | ❌ | Suitable for developers |
| Graphical User Interface | ❌ | ✅ | Suitable for average users |
...
| Graphical interface configuration | ❌ | ✅ | Real-time adjustment options |
| Configuration persistence | ✅ | ✅ | All support saving settings |
| **🔧 Advanced Features** |
| Test mode | ✅ | ❌ | --test parameter |
| Cross-platform testing | ✅ | ❌ | CrossPlatformTest |
| Connection Test | ❌ | ✅ | GUI-specific functions |
| Configure directory access | ❌ | ✅ | Open folders with one click |
| **🌍 Platform Support** |
| Windows | ✅ | ✅ | Fully supported |
| macOS | ✅ | ✅ | Fully supported |
| Linux | ✅ | ✅ | Fully supported |
| Server environment | ✅ | ❌ | Console version suitable for GUI-less environment |
...
| Indicators | Console Version | GUI Version | Differences |
|------|-----------|---------|------|
| **Startup time** | ~500ms | ~2s | GUI needs more initialization |
| **Memory usage** | ~50MB | ~150MB | GUI framework overhead |
| **CPU usage** | Minimal | Low-Medium | UI rendering requirements |
| **Network Efficiency** | Same | Same | Shared core logic |
| **File Operations** | Same | Same | Shared NcfService |
