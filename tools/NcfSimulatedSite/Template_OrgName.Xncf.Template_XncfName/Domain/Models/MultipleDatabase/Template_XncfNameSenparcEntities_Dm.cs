...
namespace Template_OrgName.Xncf.Template_XncfName.Models
{
    ...
    public class Template_XncfNameSenparcEntities_Dm : Template_XncfNameSenparcEntities
    {
        public Template_XncfNameSenparcEntities_Dm(DbContextOptions<Template_XncfNameSenparcEntities_Dm> dbContextOptions) : base(dbContextOptions)
        {
        }
    }
    ...
    /// <para>2. Run: PM> add-migration [update name] -c Template_XncfNameSenparcEntities_Dm -o Domain/Migrations/Migrations.Dm </para>
    /// </summary>
    public class SenparcDbContextFactory_Dm : SenparcDesignTimeDbContextFactoryBase<Template_XncfNameSenparcEntities_Dm, Register>
    {
