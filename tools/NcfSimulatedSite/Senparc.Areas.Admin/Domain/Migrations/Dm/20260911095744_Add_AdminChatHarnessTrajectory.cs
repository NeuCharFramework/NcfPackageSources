/*----------------------------------------------------------------
    ...
    文件名：20260911095744_Add_AdminChatHarnessTrajectory.cs
    文件功能描述：20260911095744_Add_AdminChatHarnessTrajectory 相关功能实现
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SessionStateJson = table.Column<string>(type: "NVARCHAR2(32767)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PayloadJson = table.Column<string>(type: "NVARCHAR2(32767)", nullable: true),
                    OccurredAt = table.Column<DateTime>(type: "TIMESTAMP", nullable: false),
