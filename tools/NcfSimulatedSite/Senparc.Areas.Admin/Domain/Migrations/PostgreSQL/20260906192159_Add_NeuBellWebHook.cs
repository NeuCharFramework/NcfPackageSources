/*----------------------------------------------------------------
    ...
    文件名：20260906192159_Add_NeuBellWebHook.cs
    文件功能描述：20260906192159_Add_NeuBellWebHook 相关功能实现
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProviderFilter = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                    Secret = table.Column<string>(type: "character varying(300)", maxLength: 300, nullable: true),
                    NotifyOnAdd = table.Column<bool>(type: "boolean", nullable: false),
                    NotifyOnRemove = table.Column<bool>(type: "boolean", nullable: false),
