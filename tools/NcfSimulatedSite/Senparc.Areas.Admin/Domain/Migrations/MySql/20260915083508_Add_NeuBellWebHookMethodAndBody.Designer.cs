/*----------------------------------------------------------------
    ...
    文件名：20260915083508_Add_NeuBellWebHookMethodAndBody.Designer.cs
    文件功能描述：数据库迁移与模型快照

    创建标识：Senparc - 20260915
    修改描述：v0.7.1 WebHook 请求方式与请求体模板迁移（MySql 手工迁移，因无可用数据库实例）
...
namespace Senparc.Areas.Admin.Domain.Migrations.MySql
{
    ...
    [Migration("20260915083508_Add_NeuBellWebHookMethodAndBody")]
