/*----------------------------------------------------------------
    ...
    文件名：20260911075529_Add_NeuBellWebHookLog.cs
    文件功能描述：20260911075529_Add_NeuBellWebHookLog 相关功能实现
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ElapsedMilliseconds = table.Column<long>(type: "NUMBER(19)", nullable: false),
                    FinishTime = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: true),
