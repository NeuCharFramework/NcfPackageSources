...
| platform | Architecture | state | Main features |
|------|------|------|----------|
...
| components | Version | Cross-platform support | Remark |
|------|------|------------|------|
...
| **CommunityToolkit.Mvvm** | 8.2.1 | ✅ Fully compatible | MVVM pattern has no platform dependency |
...
- ✅ **PlatformTarget**: from`x64`Change to`AnyCPU`to support all architectures
- ✅ **SECURITY VULNERABILITY**: UPDATED`System.Text.Json`From 8.0.0 to 8.0.4
